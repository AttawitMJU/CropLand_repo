 ...
 */
public class LandUseTempDB {

    public final static String TABLE_NAME = "LAND_USE_TEMP";
    ...
    public static String getLandUseInSurveySQL(String surveyID) {
        ...
        sql.append("SELECT ");
        sql.append(LandUseTempDB.SURVEY_ID);
        sql.append(",");

        sql.append(LandUseTempDB.LAND_NO);
        sql.append(",");
        sql.append(LandUseTempDB.CARD_NO);
        sql.append(",");
        sql.append(LandUseTempDB.PLANT_YEAR);
        sql.append(",");
        sql.append(LandUseTempDB.AREA);
        sql.append(",");
        sql.append(LandUseTempDB.HAVEST_STATUS);
        sql.append(",");
        sql.append(LandUseTempDB.SEEDS);
        sql.append(",");
        sql.append(LandUseTempDB.HAS_HIRE);
        sql.append(",");
        sql.append(LandUseTempDB.LABOUR);
        sql.append(",");
        sql.append(LandUseTempDB.FUEL);
        sql.append(",");
        sql.append(LandUseTempDB.OTHER_PAID);
        sql.append(",");
        sql.append(LandUseTempDB.PRODUCT_USE);
        sql.append(",");
        sql.append(LandUseTempDB.PRODUCT_SALE);
        sql.append(",");
        sql.append(LandUseTempDB.PRICE);
        sql.append(",");
        sql.append(LandUseTempDB.INCOME_YEAR);
        sql.append(",");
        sql.append(LandUseTempDB.MARKET);
        sql.append(",");
        sql.append(LandUseTempDB.EMPLOY_TYPE);
        sql.append(",");
        sql.append(LandUseTempDB.EMPLOY_FROM);
        sql.append(",");
        sql.append(LandUseTempDB.LABOUR_TOTAL);
        sql.append(",");
        sql.append(LandUseTempDB.LABOUR_PAID);
        sql.append(",");
        sql.append(LandUseTempDB.LABOUR_TIME);
        sql.append(",");

        sql.append(LandUseTempDB.START_CROP);
        sql.append(",");
        sql.append(LandUseTempDB.END_CROP);
        sql.append(",");
        sql.append(LandUseTempDB.PLANT_TYPE);
        sql.append(",");
        sql.append(LandUseTempDB.PLANT_ID);
        sql.append(",");
        sql.append(LandUseTempDB.PLANT_DETAIL_ID);
        sql.append(",");

        sql.append(LandUseTempDB.FERTILIZER1);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER2);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER3);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER_CODE1);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER_CODE2);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER_CODE3);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER_TOTAL1);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER_TOTAL2);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER_TOTAL3);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER_PRICE1);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER_PRICE2);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER_PRICE3);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER_SUM1);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER_SUM2);
        sql.append(",");
        sql.append(LandUseTempDB.FERTILIZER_SUM3);
        sql.append(",");

        sql.append(LandUseTempDB.HORMONE_TYPE1);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_TYPE2);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_TYPE3);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_BRAND1);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_BRAND2);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_BRAND3);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_TOTAL1);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_TOTAL2);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_TOTAL3);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_PRICE1);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_PRICE2);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_PRICE3);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_SUM1);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_SUM2);
        sql.append(",");
        sql.append(LandUseTempDB.HORMONE_SUM3);
        sql.append(",");
        //sql.append(LandUseDB.UPDATE_DATE);
        //sql.append(",");
        sql.append(LandUseTempDB.UPDATE_BY);
        sql.append(",");
        sql.append(LandUseTempDB.REMARK1);
        sql.append(",");
        sql.append(LandUseTempDB.REMARK2);
        sql.append("");

        sql.append(" FROM ");
        sql.append(LandUseTempDB.TABLE_NAME);
